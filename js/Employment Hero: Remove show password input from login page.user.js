...
// @version      2025-10-11
// @description  The checkbox is deceptive, given a login checkbox is normally for 'remember me'. I'd rather not unintentionally reveal my password
// @author       Brendan Weibrecht
// @match        https://secure.employmenthero.com/users/quick_sign_in
...
(function() {
    ...
    const runWhenReady = () => {
        const showPasswordFieldLabel = Array.from(document.querySelectorAll('label')).filter(e => e.textContent === 'Show password')[0];
